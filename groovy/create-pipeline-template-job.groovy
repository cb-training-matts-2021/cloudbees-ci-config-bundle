...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/cb-training-matts-2021/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>cb-training-matts-2021</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>cb-training-matts-2021</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/cb-training-matts-2021/pipeline-template-catalog.git</repositoryUrl>
              <traits>
